            ...
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="myForm" action="{{ route('update.skill_title') }}">

                                    @csrf



                                    <input type="hidden" name="id" value="{{ $skills_title_id->id }}">
                                    <div class="row m-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Skills Title Name</h6>
                                        </div>
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="skill_title" class="form-control"
                                                value="{{ $skills_title_id->skill_title }}" />
                                        </div>
                                    </div>
