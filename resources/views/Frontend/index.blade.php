        ...
        <div class="skills__container container grid section__border">
                ...
                <div class="skills__info">
                    <div class="skills__data">
                        <a href="#" class="skills__blob">
                            <img src="{{ asset('frontend/assets/img/html-1.svg') }} " alt="skills image" />
                        </a>

                        <h3 class="skills__name">HTML</h3>
                        <div class="skills__subtitle">Intermediate</div>
                    </div>
                    <div class="skills__data">
                        ...
                        <div class="skills__subtitle">Advanced</div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__blob">
                    ...
                    <div class="skills__data">
                        ...
                        <div class="skills__subtitle">Basic</div>
                    </div>
                    <div class="skills__data">
                        <div class="skills__blob">
            ...
            <div class="skills_content">
                ...
                <div class="skills__info">
                    <div class="skills__data">
                        <div class="skills__blob">
                            <img src="{{ asset('frontend/assets/img/figma-1.svg') }} " alt="skills image" />
                        </div>
