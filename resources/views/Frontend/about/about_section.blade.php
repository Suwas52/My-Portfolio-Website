    ...
    <section class="about section" id="about">
        ...
        <div class="about__container container grid section__border">
            <div class="content">
                ...
                <h3 class="content-description">
                    {{ $aboutSection->long_des }} <a href="{{ route('funny.page') }}"
                        style="color: #585978; text-decoration:underline"> ghost</a> and
                    hosted in <a href="https://nestnepal.com/" style="color: #585978; text-decoration:underline">Nest
                        Nepal</a>
                </h3>
                <h3 class="content-description">
