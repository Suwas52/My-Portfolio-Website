						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="login-separater text-center mb-4"> <span class="fs-4">SIGN IN WITH EMAIL</span>
										<hr/>
									</div>
									<div class="form-body">
                                        ...
                                        @csrf
                                            ...
                                            <h4 class="text-center">Create account? <a href="{{route('register')}}">Sign Up</a></h4>
										</form>
									</div>
								</div>
							</div>
