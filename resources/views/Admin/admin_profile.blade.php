                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.profile.store') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="file" name="admin_photo" class="form-control" id="image" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($adminData->admin_photo) ? url('upload/admin_images/' . $adminData->admin_photo) : url('upload/no_image.jpg') }}"
                                                alt="Admin" class="rounded-circle p-1 bg-primary"
